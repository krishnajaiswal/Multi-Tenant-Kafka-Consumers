...
import com.nashtech.multiTenancyKafka.model.User;
...
//    User user = new User();
    ...
    public void sendMessage(KafkaConsumerMessage data, String tenantId){
...
//            kafkaMessage.setSalary(salary);
            Message<KafkaConsumerMessage> message = MessageBuilder
                    .withPayload(data)
